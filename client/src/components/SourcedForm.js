    ...
    return (
      <div>
        <div style={{ width: "800px", margin: "0 auto" }}>
          <h2 style={{ textAlign: "left", marginTop: "40px" }}>
            Below are the countries for which you have contributed
          </h2>
        </div>
                ...
                ? data.map((d, i) => {
                    return (
                      <div
                        ...
                        onClick={(e) => this.handleCountry(e, d._id)}
                        className="big-box bg1"
                      >
                        <p
                          className="btn-box"
                          style={{
                        ...
                        >
                          <span
                            className="btn-icon"
                            onClick={(e) => this.handleUpdate(e, d._id)}
                          >
