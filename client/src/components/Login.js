        ...
        {this.state.changePass ? (
          <div className="handle-pass-recovery">
            ...
            <label style={{ fontSize: "20px", padding: "20px 0" }}>
              Enter the password which is sent to you by mail
            </label>
            <input
              style={{
                display: "block",
              ...
              type="text"
              name="recoverycode"
              onChange={this.handleForgotPass}
              value={this.state.recoverycode}
              placeholder="Enter OTP"
              onKeyPress={this.confirmOTP}
            />
            <button
              style={{
                background: "#111",
          ...
          <div className="handle-pass-recovery">
            ...
            <label
              style={{ fontSize: "18px", padding: "20px 0", color: "red" }}
            >
              {this.state.err ? this.state.err.toUpperCase() : ""}
            </label>
            <label style={{ fontSize: "18px", padding: "20px 0" }}>
          ...
          <div className="flex-dash">
            <div className="signup">
              ...
              >
                <label style={{ textAlign: "left", color: "red" }}>
