...
class MainProfile extends React.Component {
  state = {
    ...
    photo:
      this.props.user.user.photo || this.props.user.user.google.photo || "",
  };
  ...
  handleFile = (e) => {
    ...
    reader.onload = (event) => sendImg(event.target.result);
          ...
          >
            <div
              style={{
                ...
                padding: "40px",
                boxShadow:
                  " -0.5px -0.5px 0 0 rgba(0,0,0,0.175), 2px 2px 10px 1px rgba(0,0,0,0.175)",
              }}
            >
              <figure style={{ textAlign: "center" }}>
                <label style={{ display: "block" }} className="userInfo">
                  {this.state.name || ""}
                </label>
              ...
              <label className="userInfo">First Name :</label>
              <h3>{this.state.firstName || "Not Available"}</h3>
              <label className="userInfo">Last Name :</label>
              <h3>{this.state.lastName || "Not Available"}</h3>
              <label className="userInfo">Name :</label>
              <h3>{this.state.name || "Not Available"}</h3>
              <label className="userInfo">Email :</label>
              <h3>{this.state.email || "Not Available"}</h3>
              <label className="userInfo">Phone Number :</label>
              <h3>{this.state.phoneNumber || "Not Available"}</h3>
              <label className="userInfo">DOB :</label>
